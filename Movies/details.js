document.addEventListener("DOMContentLoaded", async function () {
  ...
  if (movieId) {
    let result = await fetch(
      `https://api.themoviedb.org/3/movie/${movieId}?api_key=2dc4f3b7280c70e5009487448e8c74f4`
    );
...
function displayMovieDetails(movie) {
 ...
 <div class="col-md-7 mb-2">
    <h1 class="tagline text-white my-3">${movie.title}</h1>
    ...
    <div class="ParentType">
        ...
        <div class="type ng-star-inserted">
            ...
            <h4 class="my-4"><span>Rate : </span>
                ...
                <h4 class="mb-4"><span>Release Date : </span> ${movie.release_date}</h4>
                <div>
